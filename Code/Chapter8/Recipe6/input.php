<?php
	...
	switch( $user_pushed ){
		...
		case '2';
			...
			echo '<Say>For directions from the First Star to the right, press 6</Say>';
			echo '<Say>For directions from San Jose, press 7</Say>';
			echo '</Gather>';
		...
		case 4:
			...
			break;
		case 5:
			echo '<Say>Please leave a message.</Say>';
			echo '<Redirect>voicemail.php</Redirect>';
			break;
		case 6:
